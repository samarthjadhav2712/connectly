...
export async function getRecommendationUsers(req, res) {
    ...
    try {
        ...
        console.log("Error in getRecommendationUsers controller: ", err.message);
        res.status(500).json({ message: "Internal server Error" });
    }
}

export async function getMyFriends(req, res) { // FIX: Swapped req and res
    try {
...
export async function sendFriendRequest(req, res) { // FIX: Swapped req and res
    try {
...
export async function acceptFriendRequest(req, res) { // FIX: Swapped req and res
    try {
...
export async function getFriendRequests(req, res) { // FIX: Swapped req and res
    try {
...
export async function getOutgoingFriendReqs(req, res) { // FIX: Swapped req and res
    try {
