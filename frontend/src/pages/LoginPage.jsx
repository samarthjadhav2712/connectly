          ...
          <form onSubmit={handleLogin}>
            ...
            {/*Email */}
              <div className='form-control w-full space-y-2'>
                ...
                <input type="text" placeholder='hello@gmail.com' className='input input-bordered w-full' value={loginData.email} onChange={(e)=>setLoginData({...loginData , email: e.target.value})} required/>
              </div>
